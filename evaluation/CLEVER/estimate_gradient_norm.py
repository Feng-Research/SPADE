...
https://github.com/huanzhang12/CLEVER/blob/master/estimate_gradient_norm.py
"""
...
class EstimateLipschitz(object):
    ...
    def load_model(self, dataset = "mnist", model_name = "2-layer", activation = "relu", model = None, batch_size = 0, compute_slope = False, order = 1):
        ...
        from setup_mnist import MNIST, MNISTModel, TwoLayerMNISTModel, mnist_0, mnist_03
        ...
        if model is None:
            ...
            if dataset == "mnist":
                ...
                if model_name == "2-layer":
                    ...
                    if activation == "relu":
                        model =  mnist_0("models/mnist-0", self.sess, not output_logits)
                        
                elif model_name == "mnist_03":
                    if activation == "relu":
                        model =  mnist_03("models/mnist-0.3", self.sess, not output_logits)
